...
Next.js App Router · React 19 · Tailwind CSS v4 · Motion · Lenis
...
nextjs.md             ← foundations, motion, theming
references/
├── design-systems.md ← 30+ styles, palettes, font pairings
├── components/       ← copy-paste UI library
├── animated-components.md ← glowing, neon, animated variants
...
- 30+ UI styles (glassmorphism, neumorphism, brutalism, neon…)
...
Contributions, fixes, and enhancements are welcome.
